          ...
          : cart.items.isEmpty
              ...
              : Column(
                  children: [
                    ...
                    return Dismissible(
                      key: ValueKey('cart-${cartItem.listingId}'), // تأكّد أنها فريدة
                      direction: DismissDirection.endToStart,      // اسحب يمين↔يسار (أنسب لـ RTL)
                      onDismissed: (_) => cartProvider.removeItem(cartItem.listingId),
                      ...
                      secondaryBackground: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(8),        // 👈 الزوايا الدائرية
                        ),
                      ...
                      child: Card(
                        margin: const EdgeInsets.symmetric(vertical: 6),
                        child: Padding(
                          padding: const EdgeInsets.all(8), // ← مهم: لازم تكون باسم البراميتر
                          child: Row(
                            children: [
                              // --- نفس محتواك كما هو ---
                              ClipRRect(
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text("${listing.price} ل.س / ${listing.unit}",
                                        style: const TextStyle(
                                          fontSize: 14, color: AppColors.green, fontWeight: FontWeight.bold)),
                                    Text(
                              ...
                              Row(
                                ...
                                children: [
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      if (cartItem.qty > 1) {
                                        cartProvider.updateQty(cartItem.listingId, cartItem.qty - 1);
                                      } else {
                                  ...
                                  Text("${cartItem.qty}",
                                      style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w600, height: 1.0)),
                                  const SizedBox(width: 6),
                                  IconButton(
                                    icon: const Icon(Icons.add_circle_outline),
                                    onPressed: () => cartProvider.updateQty(cartItem.listingId, cartItem.qty + 1),
                                    padding: EdgeInsets.zero,
